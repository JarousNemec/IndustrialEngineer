...
namespace IndustrialEnginner.Blocks
{
    public class Water : Block, IBlock
    {
        ...
        public Block Copy()
        {
            return new Water(Id, TileId, BlocksCanPlaceOn, Name, MiningLevel, Richness, FoundationId, BlockType,
                HarvestTime, Harvestable, CanPlaceOn, CanStepOn);
        }

        public Water(int id, int tileId, int[] blocksCanPlaceOn, string name, int miningLevel, int richness,
