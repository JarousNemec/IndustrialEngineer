...
namespace IndustrialEnginner.Blocks
{
    public class Sand : Block, IBlock
    {
        ...
        public Block Copy()
        {
            return new Sand(Id, TileId, BlocksCanPlaceOn, Name, MiningLevel, Richness, FoundationId, BlockType,
                HarvestTime, Harvestable, CanPlaceOn, CanStepOn);
        }

        public Sand(int id, int tileId, int[] blocksCanPlaceOn, string name, int miningLevel, int richness,
