...
namespace IndustrialEnginner.Blocks
{
    public class Gold : Block, IBlock
    {
        ...
        public Block Copy()
        {
            return new Gold(Id, TileId, BlocksCanPlaceOn, Name, MiningLevel, Richness, FoundationId, BlockType,
                HarvestTime, Harvestable, CanPlaceOn, CanStepOn);
        }

        public Gold(int id, int tileId, int[] blocksCanPlaceOn, string name, int miningLevel, int richness,
