...
namespace IndustrialEnginner.Blocks
{
    public class Workbench : Block, IBlock
    {
        ...
        public Block Copy()
        {
            return new Workbench(Id, TileId, BlocksCanPlaceOn, Name, MiningLevel, Richness, FoundationId, BlockType,
                HarvestTime, Harvestable, CanPlaceOn, CanStepOn);
        }

        public Workbench(int id, int tileId, int[] blocksCanPlaceOn, string name, int miningLevel, int richness,
